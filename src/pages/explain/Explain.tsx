...
const Explain = (props: any) => {
  const [menu, setMenu] = useState("0")
  useEffect(() => {
    props.setMenu("explain");
  }, [props])
  return (
      ...
      <div className="explain-wrapper">
        ...
        <div className="explain-content">
          ...
          <div className="text">
            ...
            <div className="text-contents">
              <span className="text-highlight">관리자만 설문조사를 등록할 수 있습니다!</span><br/>
              또한, 설문조사에 참여할 수 있습니다.<br/>
          ...
          <div className="text">
            ...
            <div className="text-contents">
              <span className="text-highlight">관리자가 아닌 사용자는 설문조사에 참여만 할 수 있습니다!</span><br/>
            ...
            <div className="text-contents">
              ...
              <span className="text-highlight">내가 등록한 설문조사, 설문조사 등록</span>메뉴가
              나타나지 않습니다.
            </div>
            <div className="text-img">
              <img src={signup1} alt=""/>
        ...
        <div className="explain-content">
          <div className="text">
            <div className="text-title">
              1. 관리자 계정으로 로그인 후 상단의 설문조사 메뉴 선택
            </div>
            <div className="text-contents">
          ...
          <div className="text">
            ...
            <div className="text-contents">
              <span className="text-highlight">설문조사 화면 좌측 하단의 문제 추가 버튼</span>을 클릭해서 문항을 추가할 수 있습니다.<br/>
              <span className="text-highlight">문항별 우측 상단의 드롭다운 메뉴</span>에서 객관식, 주관식, 객관식(사진) 유형을 선택할 수 있습니다.<br/>
              <span className="text-highlight">문항별 우측 하단의 삭제하기 버튼</span>으로 문항을 삭제할 수 있습니다.<br/>
              <span className="text-highlight">객관식, 객관식(사진) 유형의 문항 좌측 하단의 보기추가 버튼</span>으로 보기를 추가할 수 있습니다.<br/>
              <span className="text-highlight">객관식, 객관식(사진) 유형의 보기 옆 X 버튼</span>을 클릭해서 보기를 삭제할 수 있습니다.<br/>
        ...
        <div className="explain-content">
          <div className="text">
            <div className="text-title">
              1. 관리자 계정으로 로그인 후 상단의 내가 등록한 설문조사 메뉴 선택
            </div>
            <div className="text-contents">
          ...
          <div className="text">
            ...
            <div className="text-contents">
              내가 등록한 설문조사 목록에서 수정하실 설문조사를 선택하세요!
            </div>
            <div className="text-img">
              <img src={joinsurvey2}/>
            </div>
          ...
          <div className="text">
            ...
            <div className="text-contents">
              설문 조사를 등록할 당시의 화면이 나타납니다.<br/>
              <span className="text-highlight">우측 하단의 삭제하기 버튼</span>을 클릭하면 등록한 설문조사와 모든 응답 결과가 삭제됩니다!<br/>
              <span className="text-highlight">우측 하단의 수정하기 버튼</span>을 클릭해서 설문조사를 수정할 수 있습니다.<br/>
              만약, 설문조사를 수정하면 설문조사의 <span className="text-highlight">응답 결과가 모두 사라집니다!</span>
            </div>
            <div className="text-img">
              <img src={editsurvey3}/>
            </div>
        ...
        <div className="explain-content">
          ...
          <div className="text">
            ...
            <div className="text-contents">
              내가 등록한 설문조사 목록에서 결과를 확인할 설문조사를 선택하세요!
            </div>
            <div className="text-img">
              <img src={joinsurvey2}/>
            </div>
          ...
          <div className="text">
            ...
            <div className="text-contents">
              설문조사의 <span className="text-highlight">결과를 한눈</span>에 확인할 수 있습니다!<br/>
            </div>
            <div className="text-img">
