...
const MyInfo = (props: any) => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    changed_password2: Yup
      .string()
      .oneOf([Yup.ref('changed_password'), null],
        '변경할 비밀번호가 일치하지 않습니다')
      .required("필수 입력 값입니다!")
  })
  const submit = async (values: any) => {
    ...
    try {
      ...
      toast.success(<div>비밀번호 변경이 완료되었습니다!<br/>다시 로그인해주세요!</div>, {
        position: "top-center",
        autoClose: 2000
      });
      window.setTimeout(() => {
  ...
  return (
    <div className="myinfo-wrapper">
      ...
      <div className="myinfo-content">
        <Menu
          className="myinfo-menu" defaultSelectedKeys={['1']}
